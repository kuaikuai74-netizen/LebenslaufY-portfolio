...
export const works = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      summary:
        '集中展示 Logo 设计、视觉优化数据看板与可视化模型动态实验，补充电商视觉、品牌物料之外的创作实践。',
      meta: [
        { label: '内容', value: 'Logo 设计 / 视觉优化 / 可视化模型' },
        { label: '形式', value: '数据看板 / 方案图 / 动态视频' },
        { label: '产出', value: '9 张静态设计图 / 6 段动态作品' },
      ],
      structure: [
        { label: '内容范围', value: '整理不属于现有四个作品分类的视觉设计、视觉优化分析和动态实验，让不同方向的创作能够集中呈现。' },
        { label: '展示目标', value: '保留图形、数据看板和动态模型各自的观看方式，同时延续作品集统一的浏览体验。' },
        { label: '创作内容', value: '包含 Logo 视觉设计、8 张视觉优化数据与管理看板，以及 6 段竖版可视化模型动态作品。' },
      ...
      details: [
        ...
        '视觉优化案例涵盖数据复盘、项目管理仪表盘、全景看板与策略分析材料，按原始比例展示关键内容。',
