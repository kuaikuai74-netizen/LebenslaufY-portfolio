...
function ServiceProfileOverlay({ profile, onClose }) {
  return (
    ...
    >
      <div className="relative mx-auto grid max-w-5xl overflow-hidden rounded-[1.25rem] border border-white/50 bg-paper shadow-[0_40px_120px_rgba(0,0,0,0.26)] sm:rounded-[2rem] lg:grid-cols-[0.34fr_0.66fr]">
        <button
